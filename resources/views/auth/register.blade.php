<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <p class="text-slate-500 text-sm mt-1">Join the PriceFlex trading network</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-5">
        ...
        <!-- Password -->
        <div>
            <x-input-label for="password" :value="__('Security Pin')" />
        ...
        <div>
            ...
            <x-text-input id="password_confirmation" class="block w-full"
                            ...
                            placeholder="Repeat security pin" />
        ...
        <div class="text-center mt-6">
            <p class="text-xs text-slate-500">
                ...
                <a href="{{ route('login') }}" class="text-cyan-400 font-bold hover:underline">Log in here</a>
            </p>
        </div>
    </form>
</x-guest-layout>
